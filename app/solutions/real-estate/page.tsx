...
import { Buildings, FileText, Drop, Warning, Check, ArrowRight } from "@phosphor-icons/react"
      ...
      <section className="pt-32 pb-20 px-8 relative overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Real estate property compliance"
            fill
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="text-center">
            <p className="text-fog text-[15px] mb-8">
              Need real estate compliance plus another compliance area? Add any vertical for <span className="text-gold font-semibold">+$397/month</span>. No additional setup fee.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup" className="inline-flex items-center justify-center gap-2 bg-crimson text-parchment font-display font-semibold text-[11px] tracking-[3px] uppercase px-8 py-4 hover:bg-crimson/90 transition-colors">
                Start My Real Estate Compliance
