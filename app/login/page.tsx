          ...
          >
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <p className="font-display text-[12px] tracking-[2px] uppercase text-steel mt-1">
        ...
        >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <Link 
                  ...
                  className="font-display text-[12px] tracking-[1px] text-gold hover:text-gold/80 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="font-display text-[12px] tracking-[2px] uppercase">Google</span>
            </button>
            <button
              type="button"
              onClick={async () => {
            ...
            >
              ...
              <span className="font-display text-[12px] tracking-[2px] uppercase">Apple</span>
            </button>
          </div>
