      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 py-3 border border-brand-white/[0.1] text-steel hover:text-parchment hover:border-brand-white/20 transition-colors">
