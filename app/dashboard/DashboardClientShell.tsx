...
/**
 * Renamed from `DashboardLayout` so the server-component gate at
 * `app/dashboard/layout.tsx` can redirect v2-enabled clients to `/v2/briefing`
 * before this client shell mounts. See NGE-487.
 */
