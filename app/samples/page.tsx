          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="font-display font-black text-[48px] md:text-[56px] leading-[0.95] mb-6">
                See What Your AI Compliance Officer Produces.
                <br />
                <span className="text-crimson">Before You Pay.</span>
              </h1>
              <p className="font-sans text-[16px] text-fog max-w-lg mx-auto leading-relaxed">
                These are actual deliverables generated by the PROTEKON compliance
                agent. Not templates. Not outlines. Finished, site-specific documents
                — the same output your AI compliance officer produces on day one.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="bg-brand-white border border-midnight/[0.08] p-10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-midnight text-parchment p-6 border border-gold/20">
                ...
                <div className="space-y-3">
                  {[
                    "AI-generated site-specific documents",
                    "Daily 6am regulatory scans",
                    "Agent updates documents when laws change",
                    "AI incident classification + automatic PII stripping",
                    "Scheduled delivery — weekly, monthly, quarterly, annual",
                  ].map((item) => (
                    <div key={item} className="flex items-start gap-2">
