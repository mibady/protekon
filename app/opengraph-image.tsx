...
export const alt = "PROTEKON — Managed Compliance. Delivered."
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          California workplace compliance as a service — IIPP, SB 553, incident logging, and regulatory monitoring.
        </div>
      </div>
    ),
    { ...size }
