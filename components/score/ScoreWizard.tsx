...
function ScoreWizardInner() {
  ...
  /* When on the hero step, hide this component — the server-rendered hero is visible instead.
     Once the user starts the assessment, the server hero is replaced by the wizard steps. */
  if (step === "hero") {
    return (
