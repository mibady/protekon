// TradeLanding — config-driven landing page template for federal-OSHA trade pages.
// Consumed by app/score/trade/[trade]/page.tsx via one TradeLandingConfig per trade.
// California and National remain separate special-case pages (structurally different framings).
...
import type { TradeLandingConfig } from "@/lib/landing-configs/types"
...
export default function TradeLanding({ config }: { config: TradeLandingConfig }) {
  const router = useRouter()
  const go = () => router.push(`/score?start=true&industry=${config.slug}`)
    ...
    >
      ...
      >
        <Reveal>
          ...
          >
            No consultants. No spreadsheets. Your {config.transformation.lede_qualifier} compliance score is calculated the moment you finish — backed by real federal OSHA enforcement data.
          </p>
        </Reveal>
        ...
        >
          {[
            ...
            },
            {
              ...
              d: `Compliance score, gap analysis, and fine exposure — calculated against real citations of ${config.transformation.step02_trade_plural}. Your personalized gap analysis in minutes.`,
              c: B.gold,
            },
            {
              n: "03",
            ...
            {[
              {
                ...
                d: `Not a generic checklist. Weighted against real enforcement data for ${config.benefits.trade_plural}. Real federal OSHA records. Your number.`,
                tag: "Benefit",
              },
              {
                t: "Every gap, named and priced",
                d: `Each gap mapped to the exact ${config.benefits.subpart} citation, the classification (serious / willful / repeat), and the fine range an inspector would assess. No guessing.`,
                tag: "Benefit",
              },
              {
                t: "Total fine exposure in dollars",
                d: `One number: what it costs if federal OSHA walks in today. Most ${config.benefits.trade_plural} we assess carry ${config.benefits.risk_range} in exposure they do not know about.`,
                tag: "Benefit",
              },
              {
          ...
          <Reveal delay={0.08}>
            {[
              ...
              },
              {
                ...
                a: "We use actual federal OSHA penalty amounts per standard. Fine ranges reflect real differences between first-time serious citations ($1,036\u2013$16,131) and willful/repeat violations ($11,524\u2013$161,323). Your specific amount depends on company size and violation history \u2014 that\u2019s why we show a range.",
              },
              {
                q: "Is this just a marketing gimmick?",
                a: `The questions map directly to what a federal OSHA inspector checks during a walkaround under ${config.faq.close_subpart}. If your score comes back green, you probably don\u2019t need us. If it comes back red, you need somebody \u2014 we happen to be the fastest.`,
              },
              {
                q: "Is this just for big companies?",
                a: `No. ${config.faq.small_shop_facts}. The assessment adapts to your headcount and surfaces the citations most likely to hit a small shop in your trade.`,
              },
              {
                q: "What if my industry isn\u2019t listed?",
                a: "We cover 27 verticals. Select the closest match \u2014 the baseline federal OSHA questions apply to every employer regardless of industry.",
              },
              {
      ...
      >
        ...
        >
          <Reveal>
            ...
            >
              Real results. Your {config.cta.lede_trade_plural} compliance score and fine exposure — calculated against the same enforcement data federal OSHA uses to decide who to inspect next.
            </p>
            ...
            >
              ...
              and real federal OSHA enforcement data. PROTEKON is not a
              law firm.
            </p>
          </Reveal>
        </div>
